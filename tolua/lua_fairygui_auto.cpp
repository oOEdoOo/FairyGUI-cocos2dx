#include "scripting/lua-bindings/manual/lua_fairygui_auto.hpp"
#include "FairyGUI.h"
#include "scripting/lua-bindings/manual/tolua_fix.h"
#include "scripting/lua-bindings/manual/LuaBasicConversions.h"

int lua_fairygui_GController_getPageIndexById(lua_State* tolua_S)
{
    int argc = 0;
...
int lua_fairygui_GController_setSelectedPage(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GController_getPrevisousIndex(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GController_getPrevisousIndex'", nullptr);
            return 0;
        }
...
int lua_fairygui_GController_setSelectedIndex(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GController_getPageId(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GController_getSelectedPageId(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GController_getSelectedPageId'", nullptr);
            return 0;
        }
...
int lua_fairygui_GController_setParent(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GController_setup(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GController_setup'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GController_setup'", nullptr);
            return 0;
        }
        cobj->setup(arg0);
        lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GController_setup'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GController_hasPage(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GController_setOppositePageId(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GController_runActions(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GController_runActions'", nullptr);
            return 0;
        }
        cobj->runActions();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_GController_getPageNameById(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GController_getPreviousPageId(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GController_getPreviousPageId'", nullptr);
            return 0;
        }
...
int lua_fairygui_GController_getPageCount(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GController_getPageCount'", nullptr);
            return 0;
        }
...
int lua_fairygui_GController_getSelectedIndex(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GController_getSelectedIndex'", nullptr);
            return 0;
        }
...
int lua_fairygui_GController_getPreviousPage(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GController_getPreviousPage'", nullptr);
            return 0;
        }
...
int lua_fairygui_GController_setSelectedPageId(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GController_getSelectedPage(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GController_getSelectedPage'", nullptr);
            return 0;
        }
...
int lua_fairygui_GController_getParent(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GController_getParent'", nullptr);
            return 0;
        }
...
int lua_fairygui_GController_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GController* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GController_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GController_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GController_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GController)");
    return 0;
}

int lua_register_fairygui_GController(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GController");
        tolua_function(tolua_S,"new",lua_fairygui_GController_constructor);
        ...
        tolua_function(tolua_S,"setup",lua_fairygui_GController_setup);
...
int lua_fairygui_Relations_setup(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Relations* cobj = nullptr;
    bool ok  = true;
    ...
    cobj = (fairygui::Relations*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_Relations_setup'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_object<fairygui::ByteBuffer>(tolua_S, 2, "fgui.ByteBuffer",&arg0, "fgui.Relations:setup");

        ok &= luaval_to_boolean(tolua_S, 3,&arg1, "fgui.Relations:setup");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Relations_setup'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fgui.Relations:setup",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_Relations_setup'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_Relations_contains(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Relations* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_Relations_contains'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<fairygui::GObject>(tolua_S, 2, "fgui.GObject",&arg0, "fgui.Relations:contains");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Relations_contains'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_Relations_contains'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_Relations_onOwnerSizeChanged(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Relations* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_Relations_onOwnerSizeChanged'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 3) 
    {
        ...
        ok &= luaval_to_number(tolua_S, 2,&arg0, "fgui.Relations:onOwnerSizeChanged");

        ok &= luaval_to_number(tolua_S, 3,&arg1, "fgui.Relations:onOwnerSizeChanged");

        ok &= luaval_to_boolean(tolua_S, 4,&arg2, "fgui.Relations:onOwnerSizeChanged");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Relations_onOwnerSizeChanged'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fgui.Relations:onOwnerSizeChanged",argc, 3);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_Relations_onOwnerSizeChanged'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_Relations_remove(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Relations* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_Relations_remove'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_object<fairygui::GObject>(tolua_S, 2, "fgui.GObject",&arg0, "fgui.Relations:remove");

        ok &= luaval_to_int32(tolua_S, 3,(int *)&arg1, "fgui.Relations:remove");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Relations_remove'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_Relations_remove'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_Relations_clearFor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Relations* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_Relations_clearFor'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<fairygui::GObject>(tolua_S, 2, "fgui.GObject",&arg0, "fgui.Relations:clearFor");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Relations_clearFor'", nullptr);
            return 0;
        }
        cobj->clearFor(arg0);
        lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_Relations_clearFor'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_Relations_add(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Relations* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_Relations_add'", nullptr);
        return 0;
    }
#endif
    argc = lua_gettop(tolua_S)-1;
    do{
        if (argc == 3) {
            fairygui::GObject* arg0;
            ok &= luaval_to_object<fairygui::GObject>(tolua_S, 2, "fgui.GObject",&arg0, "fgui.Relations:add");
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_Relations_add'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_Relations_isEmpty(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Relations* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_Relations_isEmpty'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Relations_isEmpty'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_Relations_isEmpty'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_Relations_clearAll(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Relations* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_Relations_clearAll'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Relations_clearAll'", nullptr);
            return 0;
        }
        cobj->clearAll();
        lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_Relations_clearAll'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_Relations_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Relations* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_object<fairygui::GObject>(tolua_S, 2, "fgui.GObject",&arg0, "fgui.Relations:Relations");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Relations_constructor'", nullptr);
            return 0;
        }
        cobj = new fairygui::Relations(arg0);
        tolua_pushusertype(tolua_S,(void*)cobj,"fgui.Relations");
        tolua_register_gc(tolua_S,lua_gettop(tolua_S));
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fgui.Relations:Relations",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_Relations_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_Relations_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (Relations)");
    return 0;
}

int lua_register_fairygui_Relations(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Relations");
        tolua_function(tolua_S,"new",lua_fairygui_Relations_constructor);
        tolua_function(tolua_S,"setup",lua_fairygui_Relations_setup);
        tolua_function(tolua_S,"contains",lua_fairygui_Relations_contains);
        tolua_function(tolua_S,"onOwnerSizeChanged",lua_fairygui_Relations_onOwnerSizeChanged);
        tolua_function(tolua_S,"remove",lua_fairygui_Relations_remove);
        tolua_function(tolua_S,"clearFor",lua_fairygui_Relations_clearFor);
        tolua_function(tolua_S,"add",lua_fairygui_Relations_add);
        tolua_function(tolua_S,"isEmpty",lua_fairygui_Relations_isEmpty);
        tolua_function(tolua_S,"clearAll",lua_fairygui_Relations_clearAll);
    tolua_endmodule(tolua_S);
...
int lua_fairygui_GObject_setGroup(lua_State* tolua_S)
{
    int argc = 0;
...
int lua_fairygui_GObject_getSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getSize'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_getSortingOrder(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getSortingOrder'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_isGrayed(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_isGrayed'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_getGroup(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getGroup'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_setRotation(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_setPixelSnapping(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_setScaleY(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_setScaleX(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_isPixelSnapping(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_isPixelSnapping'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_setDraggable(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_setYMin(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_setYMin'", nullptr);
            return 0;
        }
        cobj->setYMin(arg0);
        lua_settop(tolua_S, 1);
...
int lua_fairygui_GObject_setXMin(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_setXMin'", nullptr);
            return 0;
        }
        cobj->setXMin(arg0);
        lua_settop(tolua_S, 1);
...
int lua_fairygui_GObject_onStage(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_onStage'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_getIcon(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getIcon'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_setPivot(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_getAlpha(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getAlpha'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_setSkewX(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_setSkewY(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_setSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_getTooltips(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getTooltips'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_startDrag(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_isDraggable(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_isDraggable'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_setTouchable(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_globalToLocal(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_removeLuaClickCallback(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GObject_removeLuaClickCallback'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_removeLuaClickCallback'", nullptr);
            return 0;
        }
        cobj->removeLuaClickCallback();
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fgui.GObject:removeLuaClickCallback",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GObject_removeLuaClickCallback'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GObject_constructFromResource(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_constructFromResource'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_addDisplayLock(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_addDisplayLock'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_isTouchable(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_isTouchable'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_getResourceURL(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getResourceURL'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_makeFullScreen(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_makeFullScreen'", nullptr);
            return 0;
        }
        cobj->makeFullScreen();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_GObject_isPivotAsAnchor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_isPivotAsAnchor'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_setPosition(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_getDragBounds(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getDragBounds'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_setVisible(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_setCustomData(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_getGear(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_isVisible(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_isVisible'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_getText(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getText'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_getWidth(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getWidth'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_displayObject(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_displayObject'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_getRotation(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getRotation'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_setWidth(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_setTooltips(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_getPackageItem(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getPackageItem'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_relations(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_relations'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_getSkewX(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getSkewX'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_getSkewY(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getSkewY'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_releaseDisplayLock(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_setGrayed(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_getPosition(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getPosition'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_getRoot(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getRoot'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_getParent(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getParent'", nullptr);
            return 0;
        }
        fairygui::GComponent* ret = cobj->getParent();
        object_to_luaval<fairygui::GComponent>(tolua_S, "fgui.GComponent",(fairygui::GComponent*)ret);
...
int lua_fairygui_GObject_getCustomData(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getCustomData'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_setIcon(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_hitTest(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_setDragBounds(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_getXMin(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getXMin'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_removeRelation(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_setScale(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_getX(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getX'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_getY(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getY'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_stopDrag(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_stopDrag'", nullptr);
            return 0;
        }
        cobj->stopDrag();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_GObject_getScaleY(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getScaleY'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_getScaleX(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getScaleX'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_getHeight(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getHeight'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_setSortingOrder(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_setAlpha(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_localToGlobal(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_getData(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getData'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_checkGearController(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_setData(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_transformRect(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_removeFromParent(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_removeFromParent'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_findParent(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GObject_findParent'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_findParent'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GObject_findParent'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GObject_getYMin(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getYMin'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_getScale(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getScale'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_setX(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_setY(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_setHeight(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_center(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_setText(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_addRelation(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObject_getPivot(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getPivot'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_addLuaClickCallback(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GObject_addLuaClickCallback'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if (arg0 == 0)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_addLuaClickCallback'", nullptr);
            return 0;
        }
        cobj->addLuaClickCallback(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fgui.GObject:addLuaClickCallback",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GObject_addLuaClickCallback'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GObject_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_getDraggingObject(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_getDraggingObject'", nullptr);
            return 0;
        }
...
int lua_fairygui_GObject_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObject* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObject_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GObject_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GObject_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GObject)");
    return 0;
}

int lua_register_fairygui_GObject(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GObject");
        tolua_function(tolua_S,"new",lua_fairygui_GObject_constructor);
        ...
        tolua_function(tolua_S,"removeLuaClickCallback",lua_fairygui_GObject_removeLuaClickCallback);
        ...
        tolua_function(tolua_S,"findParent",lua_fairygui_GObject_findParent);
        ...
        tolua_function(tolua_S,"addLuaClickCallback",lua_fairygui_GObject_addLuaClickCallback);
...
int lua_fairygui_UIPackage_getName(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_UIPackage_getName'", nullptr);
            return 0;
        }
...
int lua_fairygui_UIPackage_getId(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::UIPackage* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_UIPackage_getId'", nullptr);
            return 0;
        }
...
int lua_fairygui_UIPackage_getItemByName(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::UIPackage* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_UIPackage_getItem(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::UIPackage* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_UIPackage_createObjectFromURL(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
int lua_fairygui_UIPackage_removePackage(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
int lua_fairygui_UIPackage_getItemURL(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
int lua_fairygui_UIPackage_normalizeURL(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
int lua_fairygui_UIPackage_removeAllPackages(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_UIPackage_removeAllPackages'", nullptr);
            return 0;
        }
...
int lua_fairygui_UIPackage_createObject(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
int lua_fairygui_UIPackage_getByName(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
int lua_fairygui_UIPackage_addPackage(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
int lua_fairygui_UIPackage_getById(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
int lua_fairygui_UIPackage_getItemByURL(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
int lua_fairygui_UIPackage_getEmptyTexture(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_UIPackage_getEmptyTexture'", nullptr);
            return 0;
        }
...
int lua_fairygui_UIPackage_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::UIPackage* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_UIPackage_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_UIPackage_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_UIPackage_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (UIPackage)");
    return 0;
}

int lua_register_fairygui_UIPackage(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"UIPackage");
        tolua_function(tolua_S,"new",lua_fairygui_UIPackage_constructor);
...
int lua_fairygui_GImage_setFillMethod(lua_State* tolua_S)
{
    int argc = 0;
...
int lua_fairygui_GImage_setFillClockwise(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GImage* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GImage_setColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GImage* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GImage_getColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GImage* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GImage_getColor'", nullptr);
            return 0;
        }
...
int lua_fairygui_GImage_getFlip(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GImage* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GImage_getFlip'", nullptr);
            return 0;
        }
...
int lua_fairygui_GImage_getFillMethod(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GImage* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GImage_getFillMethod'", nullptr);
            return 0;
        }
...
int lua_fairygui_GImage_setFlip(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GImage* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GImage_setFillAmount(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GImage* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GImage_isFillClockwise(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GImage* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GImage_isFillClockwise'", nullptr);
            return 0;
        }
...
int lua_fairygui_GImage_getFillAmount(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GImage* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GImage_getFillAmount'", nullptr);
            return 0;
        }
...
int lua_fairygui_GImage_getFillOrigin(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GImage* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GImage_getFillOrigin'", nullptr);
            return 0;
        }
...
int lua_fairygui_GImage_setFillOrigin(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GImage* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GImage_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GImage_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_GImage_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GImage* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GImage_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GImage_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GImage_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GImage)");
    return 0;
}

int lua_register_fairygui_GImage(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GImage");
        tolua_function(tolua_S,"new",lua_fairygui_GImage_constructor);
...
int lua_fairygui_GMovieClip_advance(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GMovieClip_advance'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GMovieClip_advance'", nullptr);
            return 0;
        }
        cobj->advance(arg0);
        lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GMovieClip_advance'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GMovieClip_setTimeScale(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GMovieClip* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GMovieClip_setTimeScale'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GMovieClip_setTimeScale'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GMovieClip_setTimeScale'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GMovieClip_setColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GMovieClip* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GMovieClip_setFrame(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GMovieClip* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GMovieClip_getColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GMovieClip* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GMovieClip_getColor'", nullptr);
            return 0;
        }
        cocos2d::Color3B ret = cobj->getColor();
        color3b_to_luaval(tolua_S, ret);
...
int lua_fairygui_GMovieClip_getFlip(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GMovieClip* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GMovieClip_getFlip'", nullptr);
            return 0;
        }
        int ret = (int)cobj->getFlip();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_GMovieClip_getFrame(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GMovieClip* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GMovieClip_getFrame'", nullptr);
            return 0;
        }
...
int lua_fairygui_GMovieClip_setFlip(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GMovieClip* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GMovieClip_setPlaying(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GMovieClip* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GMovieClip_setPlaySettings(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GMovieClip* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GMovieClip_isPlaying(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GMovieClip* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GMovieClip_isPlaying'", nullptr);
            return 0;
        }
...
int lua_fairygui_GMovieClip_getTimeScale(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GMovieClip* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GMovieClip_getTimeScale'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GMovieClip_getTimeScale'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GMovieClip_getTimeScale'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GMovieClip_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GMovieClip_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_GMovieClip_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GMovieClip* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GMovieClip_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GMovieClip_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GMovieClip_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GMovieClip)");
    return 0;
}

int lua_register_fairygui_GMovieClip(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GMovieClip");
        tolua_function(tolua_S,"new",lua_fairygui_GMovieClip_constructor);
        tolua_function(tolua_S,"advance",lua_fairygui_GMovieClip_advance);
        tolua_function(tolua_S,"setTimeScale",lua_fairygui_GMovieClip_setTimeScale);
        ...
        tolua_function(tolua_S,"getTimeScale",lua_fairygui_GMovieClip_getTimeScale);
...
int lua_fairygui_TextFormat_hasEffect(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_TextFormat_hasEffect'", nullptr);
            return 0;
        }
...
int lua_fairygui_TextFormat_enableEffect(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::TextFormat* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_TextFormat_enableEffect'", nullptr);
            return 0;
        }
...
int lua_fairygui_TextFormat_disableEffect(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::TextFormat* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_TextFormat_disableEffect'", nullptr);
            return 0;
        }
...
int lua_fairygui_TextFormat_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::TextFormat* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_TextFormat_constructor'", nullptr);
            return 0;
        }
        cobj = new fairygui::TextFormat();
        tolua_pushusertype(tolua_S,(void*)cobj,"fgui.TextFormat");
        tolua_register_gc(tolua_S,lua_gettop(tolua_S));
        return 1;
    }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_TextFormat_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_TextFormat_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (TextFormat)");
    return 0;
}

int lua_register_fairygui_TextFormat(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"TextFormat");
        tolua_function(tolua_S,"new",lua_fairygui_TextFormat_constructor);
...
int lua_fairygui_GRichTextField_setString(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GRichTextField_setString'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "fgui.GRichTextField:setString");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRichTextField_setString'", nullptr);
            return 0;
        }
        cobj->setString(arg0);
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fgui.GRichTextField:setString",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GRichTextField_setString'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GRichTextField_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRichTextField_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_GRichTextField_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRichTextField* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRichTextField_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GRichTextField_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GRichTextField_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GRichTextField)");
    return 0;
}

int lua_register_fairygui_GRichTextField(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GRichTextField");
        tolua_function(tolua_S,"new",lua_fairygui_GRichTextField_constructor);
        tolua_function(tolua_S,"setString",lua_fairygui_GRichTextField_setString);
...
int lua_fairygui_GTextInput_setOnSubmit(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GTextInput_setOnSubmit'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if (arg0 == 0)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTextInput_setOnSubmit'", nullptr);
            return 0;
        }
        cobj->setOnSubmit(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fgui.GTextInput:setOnSubmit",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GTextInput_setOnSubmit'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GTextInput_getString(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextInput* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GTextInput_getString'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTextInput_getString'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GTextInput_getString'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GTextInput_setKeyboardType(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextInput* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GTextInput_setString(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextInput* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GTextInput_setString'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTextInput_setString'", nullptr);
            return 0;
        }
        cobj->setString(arg0);
        lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GTextInput_setString'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GTextInput_setPrompt(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextInput* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GTextInput_setMaxLength(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextInput* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GTextInput_setRestrict(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextInput* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GTextInput_setPassword(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextInput* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GTextInput_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTextInput_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTextInput_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextInput* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTextInput_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GTextInput_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GTextInput_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GTextInput)");
    return 0;
}

int lua_register_fairygui_GTextInput(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GTextInput");
        tolua_function(tolua_S,"new",lua_fairygui_GTextInput_constructor);
        tolua_function(tolua_S,"setOnSubmit",lua_fairygui_GTextInput_setOnSubmit);
        tolua_function(tolua_S,"getString",lua_fairygui_GTextInput_getString);
        tolua_function(tolua_S,"setKeyboardType",lua_fairygui_GTextInput_setKeyboardType);
        tolua_function(tolua_S,"setString",lua_fairygui_GTextInput_setString);
...
int lua_fairygui_GGraph_drawEllipse(lua_State* tolua_S)
{
    int argc = 0;
...
int lua_fairygui_GGraph_setColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GGraph* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GGraph_getColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GGraph* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GGraph_getColor'", nullptr);
            return 0;
        }
        cocos2d::Color3B ret = cobj->getColor();
        color3b_to_luaval(tolua_S, ret);
...
int lua_fairygui_GGraph_isEmpty(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GGraph* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GGraph_isEmpty'", nullptr);
            return 0;
        }
        bool ret = cobj->isEmpty();
        tolua_pushboolean(tolua_S,(bool)ret);
...
int lua_fairygui_GGraph_drawRect(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GGraph* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GGraph_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GGraph_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_GGraph_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GGraph* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GGraph_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GGraph_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GGraph_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GGraph)");
    return 0;
}

int lua_register_fairygui_GGraph(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GGraph");
        tolua_function(tolua_S,"new",lua_fairygui_GGraph_constructor);
...
int lua_fairygui_GLoader_getURL(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_getURL'", nullptr);
            return 0;
        }
...
int lua_fairygui_GLoader_setTimeScale(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GLoader_setTimeScale'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_setTimeScale'", nullptr);
            return 0;
        }
        cobj->setTimeScale(arg0);
        lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GLoader_setTimeScale'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GLoader_getFillAmount(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_getFillAmount'", nullptr);
            return 0;
        }
        double ret = cobj->getFillAmount();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_GLoader_getFillOrigin(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_getFillOrigin'", nullptr);
            return 0;
        }
        int ret = (int)cobj->getFillOrigin();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_GLoader_setVerticalAlign(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GLoader_setFillMethod(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GLoader_getAlign(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_getAlign'", nullptr);
            return 0;
        }
...
int lua_fairygui_GLoader_getFrame(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_getFrame'", nullptr);
            return 0;
        }
        int ret = cobj->getFrame();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_GLoader_getFillMethod(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_getFillMethod'", nullptr);
            return 0;
        }
        int ret = (int)cobj->getFillMethod();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_GLoader_isFillClockwise(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_isFillClockwise'", nullptr);
            return 0;
        }
        bool ret = cobj->isFillClockwise();
        tolua_pushboolean(tolua_S,(bool)ret);
...
int lua_fairygui_GLoader_getComponent(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_getComponent'", nullptr);
            return 0;
        }
...
int lua_fairygui_GLoader_getContentSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_getContentSize'", nullptr);
            return 0;
        }
...
int lua_fairygui_GLoader_advance(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GLoader_advance'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_advance'", nullptr);
            return 0;
        }
        cobj->advance(arg0);
        lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GLoader_advance'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GLoader_setFillOrigin(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GLoader_getVerticalAlign(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_getVerticalAlign'", nullptr);
            return 0;
        }
...
int lua_fairygui_GLoader_setAlign(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GLoader_getColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_getColor'", nullptr);
            return 0;
        }
        cocos2d::Color3B ret = cobj->getColor();
        color3b_to_luaval(tolua_S, ret);
...
int lua_fairygui_GLoader_setURL(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GLoader_setPlaying(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GLoader_setFillClockwise(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GLoader_getFUISprite(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GLoader_getFUISprite'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_getFUISprite'", nullptr);
            return 0;
        }
        cocos2d::Sprite* ret = cobj->getFUISprite();
        object_to_luaval<cocos2d::Sprite>(tolua_S, "cc.Sprite",(cocos2d::Sprite*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fgui.GLoader:getFUISprite",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GLoader_getFUISprite'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GLoader_isPlaying(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_isPlaying'", nullptr);
            return 0;
        }
        bool ret = cobj->isPlaying();
        tolua_pushboolean(tolua_S,(bool)ret);
...
int lua_fairygui_GLoader_isShrinkOnly(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_isShrinkOnly'", nullptr);
            return 0;
        }
...
int lua_fairygui_GLoader_getTimeScale(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GLoader_getTimeScale'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_getTimeScale'", nullptr);
            return 0;
        }
        double ret = cobj->getTimeScale();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GLoader_getTimeScale'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GLoader_setAutoSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GLoader_setShrinkOnly(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GLoader_setColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GLoader_setFrame(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GLoader_getFill(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_getFill'", nullptr);
            return 0;
        }
...
int lua_fairygui_GLoader_setFillAmount(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GLoader_getAutoSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_getAutoSize'", nullptr);
            return 0;
        }
...
int lua_fairygui_GLoader_setFill(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GLoader_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_GLoader_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLoader* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLoader_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GLoader_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GLoader_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GLoader)");
    return 0;
}

int lua_register_fairygui_GLoader(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GLoader");
        tolua_function(tolua_S,"new",lua_fairygui_GLoader_constructor);
        tolua_function(tolua_S,"getURL",lua_fairygui_GLoader_getURL);
        tolua_function(tolua_S,"setTimeScale",lua_fairygui_GLoader_setTimeScale);
        ...
        tolua_function(tolua_S,"advance",lua_fairygui_GLoader_advance);
        ...
        tolua_function(tolua_S,"getFUISprite",lua_fairygui_GLoader_getFUISprite);
        ...
        tolua_function(tolua_S,"getTimeScale",lua_fairygui_GLoader_getTimeScale);
...
int lua_fairygui_GGroup_getColumnGap(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GGroup_getColumnGap'", nullptr);
            return 0;
        }
...
int lua_fairygui_GGroup_resizeChildren(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GGroup* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GGroup_setLayout(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GGroup* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GGroup_setColumnGap(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GGroup* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GGroup_setBoundsChangedFlag(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GGroup* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GGroup_moveChildren(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GGroup* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GGroup_getLineGap(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GGroup* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GGroup_getLineGap'", nullptr);
            return 0;
        }
...
int lua_fairygui_GGroup_setLineGap(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GGroup* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GGroup_getLayout(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GGroup* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GGroup_getLayout'", nullptr);
            return 0;
        }
...
int lua_fairygui_GGroup_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GGroup_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_GGroup_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GGroup* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GGroup_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GGroup_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GGroup_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GGroup)");
    return 0;
}

int lua_register_fairygui_GGroup(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GGroup");
        tolua_function(tolua_S,"new",lua_fairygui_GGroup_constructor);
...
int lua_fairygui_Transition_setup(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_Transition_setup'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Transition_setup'", nullptr);
            return 0;
        }
        cobj->setup(arg0);
        lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_Transition_setup'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_Transition_play(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Transition_setPaused(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_Transition_setPaused'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Transition_setPaused'", nullptr);
            return 0;
        }
        cobj->setPaused(arg0);
        lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_Transition_setPaused'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_Transition_setTimeScale(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Transition_getLabelTime(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_Transition_getLabelTime'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Transition_getLabelTime'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_Transition_getLabelTime'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_Transition_changePlayTimes(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Transition_onOwnerRemovedFromStage(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Transition_onOwnerRemovedFromStage'", nullptr);
            return 0;
        }
...
int lua_fairygui_Transition_setTarget(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Transition_clearHooks(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Transition_clearHooks'", nullptr);
            return 0;
        }
        cobj->clearHooks();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_Transition_stop(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Transition_setDuration(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Transition_getTimeScale(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Transition_getTimeScale'", nullptr);
            return 0;
        }
        double ret = cobj->getTimeScale();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_Transition_getOwner(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Transition_getOwner'", nullptr);
            return 0;
        }
...
int lua_fairygui_Transition_setHook(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Transition_setValue(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Transition_onOwnerAddedToStage(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_Transition_onOwnerAddedToStage'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Transition_onOwnerAddedToStage'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_Transition_onOwnerAddedToStage'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_Transition_isPlaying(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Transition_isPlaying'", nullptr);
            return 0;
        }
        bool ret = cobj->isPlaying();
        tolua_pushboolean(tolua_S,(bool)ret);
...
int lua_fairygui_Transition_setAutoPlay(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Transition_updateFromRelations(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Transition_playReverse(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Transition_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Transition* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Transition_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_Transition_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_Transition_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (Transition)");
    return 0;
}

int lua_register_fairygui_Transition(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Transition");
        tolua_function(tolua_S,"new",lua_fairygui_Transition_constructor);
        tolua_function(tolua_S,"setup",lua_fairygui_Transition_setup);
        tolua_function(tolua_S,"play",lua_fairygui_Transition_play);
        tolua_function(tolua_S,"setPaused",lua_fairygui_Transition_setPaused);
        tolua_function(tolua_S,"setTimeScale",lua_fairygui_Transition_setTimeScale);
        tolua_function(tolua_S,"getLabelTime",lua_fairygui_Transition_getLabelTime);
        ...
        tolua_function(tolua_S,"onOwnerAddedToStage",lua_fairygui_Transition_onOwnerAddedToStage);
...
int lua_fairygui_ScrollPane_setBouncebackEffect(lua_State* tolua_S)
{
    int argc = 0;
...
int lua_fairygui_ScrollPane_getHzScrollBar(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getHzScrollBar'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_scrollToView(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_getDecelerationRate(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getDecelerationRate'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_getPercX(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getPercX'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_getPosY(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getPosY'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_getFooter(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getFooter'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_setPosX(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_getPosX(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getPosX'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_setPageY(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_scrollTop(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_isSnapToItem(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_isSnapToItem'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_isTouchEffect(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_isTouchEffect'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_setScrollStep(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_scrollBottom(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_isChildInView(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_isPageMode(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_isPageMode'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_setDecelerationRate(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_getScrollingPosY(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getScrollingPosY'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_getScrollingPosX(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getScrollingPosX'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_getContentSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getContentSize'", nullptr);
            return 0;
        }
        const cocos2d::Size& ret = cobj->getContentSize();
        size_to_luaval(tolua_S, ret);
...
int lua_fairygui_ScrollPane_isRightMost(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_isRightMost'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_setPageController(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_lockHeader(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_lockFooter(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_scrollDown(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_setSnapToItem(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_getScrollStep(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getScrollStep'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_getPageX(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getPageX'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_scrollLeft(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_getViewSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getViewSize'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_setInertiaDisabled(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_getPageController(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getPageController'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_setPageX(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_scrollUp(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_isMouseWheelEnabled(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_isMouseWheelEnabled'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_setPageMode(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_setTouchEffect(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_setMouseWheelEnabled(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_isInertiaDisabled(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_isInertiaDisabled'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_setPercX(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_setPercY(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_cancelDragging(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_cancelDragging'", nullptr);
            return 0;
        }
        cobj->cancelDragging();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_ScrollPane_getPercY(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getPercY'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_scrollRight(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_setup(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_ScrollPane_setup'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_setup'", nullptr);
            return 0;
        }
        cobj->setup(arg0);
        lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_ScrollPane_setup'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_ScrollPane_getVtScrollBar(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getVtScrollBar'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_getOwner(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getOwner'", nullptr);
            return 0;
        }
        fairygui::GComponent* ret = cobj->getOwner();
        object_to_luaval<fairygui::GComponent>(tolua_S, "fgui.GComponent",(fairygui::GComponent*)ret);
...
int lua_fairygui_ScrollPane_isBottomMost(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_isBottomMost'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_getPageY(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getPageY'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_isBouncebackEffect(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_isBouncebackEffect'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_setPosY(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_ScrollPane_getHeader(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getHeader'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_getDraggingPane(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_getDraggingPane'", nullptr);
            return 0;
        }
...
int lua_fairygui_ScrollPane_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::ScrollPane* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_ScrollPane_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_ScrollPane_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_ScrollPane_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (ScrollPane)");
    return 0;
}

int lua_register_fairygui_ScrollPane(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"ScrollPane");
        tolua_function(tolua_S,"new",lua_fairygui_ScrollPane_constructor);
        ...
        tolua_function(tolua_S,"setup",lua_fairygui_ScrollPane_setup);
...
int lua_fairygui_GComponent_addChild(lua_State* tolua_S)
{
    int argc = 0;
...
int lua_fairygui_GComponent_getHitArea(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_getHitArea'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_applyAllControllers(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_applyAllControllers'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_getOpaque(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_getOpaque'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_setChildrenRenderOrder(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_setOpaque(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_getViewWidth(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_getViewWidth'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_getTransitions(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_getTransitions'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_getViewHeight(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_getViewHeight'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_ensureBoundsCorrect(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_ensureBoundsCorrect'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_isAncestorOf(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_getChildren(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_getChildren'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_getMask(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_getMask'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_adjustRadioGroupDepth(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_getController(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_setApexIndex(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_getTransition(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_getFirstChildInView(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_getFirstChildInView'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_isChildInView(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_setBoundsChangedFlag(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_setBoundsChangedFlag'", nullptr);
            return 0;
        }
        cobj->setBoundsChangedFlag();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_GComponent_addChildAt(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_removeChildren(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_removeChildAt(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_getChild(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_addController(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_childSortingOrderChanged(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_applyController(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_getControllers(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_getControllers'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_setMask(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_setChildIndex(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_setViewWidth(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_getChildById(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_getChildIndex(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_getControllerAt(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_getChildAt(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_getApexIndex(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_getApexIndex'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_getScrollPane(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_getScrollPane'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_getTransitionAt(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_getChildInGroup(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_removeController(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_getSnappingPosition(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_setChildIndexBefore(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_setHitArea(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_swapChildrenAt(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_numChildren(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_numChildren'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_removeChild(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_swapChildren(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_childStateChanged(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_getChildrenRenderOrder(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_getChildrenRenderOrder'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_setViewHeight(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComponent_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GComponent_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GComponent_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GComponent)");
    return 0;
}

int lua_register_fairygui_GComponent(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GComponent");
        tolua_function(tolua_S,"new",lua_fairygui_GComponent_constructor);
...
int lua_fairygui_GLabel_setTitle(lua_State* tolua_S)
{
    int argc = 0;
...
int lua_fairygui_GLabel_getTitleFontSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLabel* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLabel_getTitleFontSize'", nullptr);
            return 0;
        }
...
int lua_fairygui_GLabel_getTitleColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLabel* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLabel_getTitleColor'", nullptr);
            return 0;
        }
...
int lua_fairygui_GLabel_getTitle(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLabel* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLabel_getTitle'", nullptr);
            return 0;
        }
...
int lua_fairygui_GLabel_getTextField(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLabel* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLabel_getTextField'", nullptr);
            return 0;
        }
...
int lua_fairygui_GLabel_setTitleFontSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLabel* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GLabel_setTitleColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLabel* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GLabel_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLabel_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_GLabel_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GLabel* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GLabel_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GLabel_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GLabel_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GLabel)");
    return 0;
}

int lua_register_fairygui_GLabel(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GLabel");
        tolua_function(tolua_S,"new",lua_fairygui_GLabel_constructor);
...
int lua_fairygui_GButton_getRelatedController(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GButton_getRelatedController'", nullptr);
            return 0;
        }
...
int lua_fairygui_GButton_setChangeStateOnClick(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GButton_setSelectedTitle(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GButton_setSelected(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GButton_setRelatedController(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GButton_setTitle(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GButton_getTitleFontSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GButton_getTitleFontSize'", nullptr);
            return 0;
        }
        int ret = cobj->getTitleFontSize();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_GButton_getSelectedIcon(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GButton_getSelectedIcon'", nullptr);
            return 0;
        }
...
int lua_fairygui_GButton_isSelected(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GButton_isSelected'", nullptr);
            return 0;
        }
...
int lua_fairygui_GButton_getTitleColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GButton_getTitleColor'", nullptr);
            return 0;
        }
        cocos2d::Color3B ret = cobj->getTitleColor();
        color3b_to_luaval(tolua_S, ret);
...
int lua_fairygui_GButton_getSelectedTitle(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GButton_getSelectedTitle'", nullptr);
            return 0;
        }
...
int lua_fairygui_GButton_getTitle(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GButton_getTitle'", nullptr);
            return 0;
        }
        const std::string& ret = cobj->getTitle();
        lua_pushlstring(tolua_S,ret.c_str(),ret.length());
...
int lua_fairygui_GButton_setSelectedIcon(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GButton_getTextField(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GButton_getTextField'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GButton_getTextField'", nullptr);
            return 0;
        }
        fairygui::GTextField* ret = cobj->getTextField();
        object_to_luaval<fairygui::GTextField>(tolua_S, "fgui.GTextField",(fairygui::GTextField*)ret);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GButton_getTextField'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GButton_isChangeStateOnClick(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GButton_isChangeStateOnClick'", nullptr);
            return 0;
        }
...
int lua_fairygui_GButton_setTitleFontSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GButton_setTitleColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GButton_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GButton_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_GButton_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GButton* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GButton_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GButton_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GButton_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GButton)");
    return 0;
}

int lua_register_fairygui_GButton(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GButton");
        tolua_function(tolua_S,"new",lua_fairygui_GButton_constructor);
        ...
        tolua_function(tolua_S,"getTextField",lua_fairygui_GButton_getTextField);
...
int lua_fairygui_GList_selectAll(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_selectAll'", nullptr);
            return 0;
        }
        cobj->selectAll();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_GList_setOnItemClickCallback(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GList_setOnItemClickCallback'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if (arg0 == 0)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_setOnItemClickCallback'", nullptr);
            return 0;
        }
        cobj->setOnItemClickCallback(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fgui.GList:setOnItemClickCallback",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GList_setOnItemClickCallback'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GList_getColumnGap(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_getColumnGap'", nullptr);
            return 0;
        }
        int ret = cobj->getColumnGap();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_GList_getLineCount(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_getLineCount'", nullptr);
            return 0;
        }
...
int lua_fairygui_GList_setVirtualAndLoop(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_setVirtualAndLoop'", nullptr);
            return 0;
        }
...
int lua_fairygui_GList_setLayout(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_refreshVirtualList(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_refreshVirtualList'", nullptr);
            return 0;
        }
...
int lua_fairygui_GList_removeSelection(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_setColumnGap(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_getColumnCount(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_getColumnCount'", nullptr);
            return 0;
        }
...
int lua_fairygui_GList_setVirtual(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_setVirtual'", nullptr);
            return 0;
        }
        cobj->setVirtual();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_GList_setNumItems(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_setVerticalAlign(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_resizeToFit(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_setSelectionController(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_returnToPool(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_clearSelection(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_clearSelection'", nullptr);
            return 0;
        }
        cobj->clearSelection();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_GList_getNumItems(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_getNumItems'", nullptr);
            return 0;
        }
...
int lua_fairygui_GList_setColumnCount(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_removeChildToPoolAt(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_addItemFromPool(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_selectReverse(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_selectReverse'", nullptr);
            return 0;
        }
        cobj->selectReverse();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_GList_setLineCount(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_setAutoResizeItem(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_getVerticalAlign(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_getVerticalAlign'", nullptr);
            return 0;
        }
        int ret = (int)cobj->getVerticalAlign();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_GList_removeChildrenToPool(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_setAlign(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_isVirtual(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_isVirtual'", nullptr);
            return 0;
        }
...
int lua_fairygui_GList_getSelectedIndex(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_getSelectedIndex'", nullptr);
            return 0;
        }
        int ret = cobj->getSelectedIndex();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_GList_getSelection(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_itemIndexToChildIndex(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_setItemRenderer(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GList_setItemRenderer'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(arg0 == 0)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_setItemRenderer'", nullptr);
            return 0;
        }
        cobj->setItemRenderer(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fgui.GList:setItemRenderer",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GList_setItemRenderer'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GList_getItemPool(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_getItemPool'", nullptr);
            return 0;
        }
...
int lua_fairygui_GList_getSelectionController(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_getSelectionController'", nullptr);
            return 0;
        }
...
int lua_fairygui_GList_getLineGap(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_getLineGap'", nullptr);
            return 0;
        }
        int ret = cobj->getLineGap();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_GList_scrollToView(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_handleArrowKey(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_getAlign(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_getAlign'", nullptr);
            return 0;
        }
        int ret = (int)cobj->getAlign();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_GList_getFromPool(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_getDefaultItem(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_getDefaultItem'", nullptr);
            return 0;
        }
...
int lua_fairygui_GList_getSelectionMode(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_getSelectionMode'", nullptr);
            return 0;
        }
...
int lua_fairygui_GList_setDefaultItem(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_setSelectedIndex(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_setSelectionMode(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_addSelection(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_childIndexToItemIndex(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_getAutoResizeItem(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_getAutoResizeItem'", nullptr);
            return 0;
        }
...
int lua_fairygui_GList_setLineGap(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_removeChildToPool(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GList_setPullDownCallback(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GList_setPullDownCallback'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if (arg0 == 0)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_setPullDownCallback'", nullptr);
            return 0;
        }
        cobj->setPullDownCallback(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fgui.GList:setPullDownCallback",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GList_setPullDownCallback'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GList_setPullUpCallback(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GList_setPullUpCallback'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if (arg0 == 0)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_setPullUpCallback'", nullptr);
            return 0;
        }
        cobj->setPullUpCallback(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fgui.GList:setPullUpCallback",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GList_setPullUpCallback'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GList_getLayout(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_getLayout'", nullptr);
            return 0;
        }
        int ret = (int)cobj->getLayout();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_GList_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_GList_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GList* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GList_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GList_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GList_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GList)");
    return 0;
}

int lua_register_fairygui_GList(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GList");
        tolua_function(tolua_S,"new",lua_fairygui_GList_constructor);
        tolua_function(tolua_S,"selectAll",lua_fairygui_GList_selectAll);
        tolua_function(tolua_S,"setOnItemClickCallback",lua_fairygui_GList_setOnItemClickCallback);
        ...
        tolua_function(tolua_S,"setItemRenderer",lua_fairygui_GList_setItemRenderer);
        ...
        tolua_function(tolua_S,"setPullDownCallback",lua_fairygui_GList_setPullDownCallback);
        tolua_function(tolua_S,"setPullUpCallback",lua_fairygui_GList_setPullUpCallback);
...
int lua_fairygui_GComboBox_refresh(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComboBox_refresh'", nullptr);
            return 0;
        }
        cobj->refresh();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_GComboBox_setValue(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComboBox_setSelectedIndex(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComboBox_getItems(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComboBox_getItems'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComboBox_getSelectedIndex(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComboBox_getSelectedIndex'", nullptr);
            return 0;
        }
        int ret = cobj->getSelectedIndex();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_GComboBox_setTitle(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComboBox_getTitleFontSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GComboBox_getTitleFontSize'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComboBox_getTitleFontSize'", nullptr);
            return 0;
        }
        int ret = cobj->getTitleFontSize();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GComboBox_getTitleFontSize'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GComboBox_getValue(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComboBox_getValue'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComboBox_getDropdown(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GComboBox_getDropdown'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComboBox_getDropdown'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GComboBox_getDropdown'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GComboBox_getTitleColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GComboBox_getTitleColor'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComboBox_getTitleColor'", nullptr);
            return 0;
        }
        cocos2d::Color3B ret = cobj->getTitleColor();
        color3b_to_luaval(tolua_S, ret);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GComboBox_getTitleColor'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GComboBox_getIcons(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComboBox_getIcons'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComboBox_getTitle(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComboBox_getTitle'", nullptr);
            return 0;
        }
        const std::string& ret = cobj->getTitle();
        lua_pushlstring(tolua_S,ret.c_str(),ret.length());
...
int lua_fairygui_GComboBox_getSelectionController(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComboBox_getSelectionController'", nullptr);
            return 0;
        }
        fairygui::GController* ret = cobj->getSelectionController();
        object_to_luaval<fairygui::GController>(tolua_S, "fgui.GController",(fairygui::GController*)ret);
...
int lua_fairygui_GComboBox_getValues(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComboBox_getValues'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComboBox_setSelectionController(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GComboBox_setTitleFontSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GComboBox_setTitleFontSize'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComboBox_setTitleFontSize'", nullptr);
            return 0;
        }
        cobj->setTitleFontSize(arg0);
        lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GComboBox_setTitleFontSize'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GComboBox_setTitleColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GComboBox_setTitleColor'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComboBox_setTitleColor'", nullptr);
            return 0;
        }
        cobj->setTitleColor(arg0);
        lua_settop(tolua_S, 1);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GComboBox_setTitleColor'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GComboBox_getTextField(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GComboBox_getTextField'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComboBox_getTextField'", nullptr);
            return 0;
        }
        fairygui::GTextField* ret = cobj->getTextField();
        object_to_luaval<fairygui::GTextField>(tolua_S, "fgui.GTextField",(fairygui::GTextField*)ret);
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GComboBox_getTextField'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_GComboBox_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComboBox_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComboBox_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComboBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComboBox_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GComboBox_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GComboBox_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GComboBox)");
    return 0;
}

int lua_register_fairygui_GComboBox(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GComboBox");
        tolua_function(tolua_S,"new",lua_fairygui_GComboBox_constructor);
        ...
        tolua_function(tolua_S,"getTitleFontSize",lua_fairygui_GComboBox_getTitleFontSize);
        tolua_function(tolua_S,"getValue",lua_fairygui_GComboBox_getValue);
        tolua_function(tolua_S,"getDropdown",lua_fairygui_GComboBox_getDropdown);
        tolua_function(tolua_S,"getTitleColor",lua_fairygui_GComboBox_getTitleColor);
        ...
        tolua_function(tolua_S,"setTitleFontSize",lua_fairygui_GComboBox_setTitleFontSize);
        tolua_function(tolua_S,"setTitleColor",lua_fairygui_GComboBox_setTitleColor);
        tolua_function(tolua_S,"getTextField",lua_fairygui_GComboBox_getTextField);
...
int lua_fairygui_GProgressBar_setValue(lua_State* tolua_S)
{
    int argc = 0;
...
int lua_fairygui_GProgressBar_setMax(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GProgressBar* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GProgressBar_getValue(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GProgressBar* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GProgressBar_getValue'", nullptr);
            return 0;
        }
...
int lua_fairygui_GProgressBar_getTitleType(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GProgressBar* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GProgressBar_getTitleType'", nullptr);
            return 0;
        }
...
int lua_fairygui_GProgressBar_tweenValue(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GProgressBar* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GProgressBar_getMax(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GProgressBar* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GProgressBar_getMax'", nullptr);
            return 0;
        }
...
int lua_fairygui_GProgressBar_setTitleType(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GProgressBar* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GProgressBar_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GProgressBar_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_GProgressBar_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GProgressBar* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GProgressBar_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GProgressBar_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GProgressBar_finalize(lua_State* tolua_S)
{
...
int lua_register_fairygui_GProgressBar(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GProgressBar");
        tolua_function(tolua_S,"new",lua_fairygui_GProgressBar_constructor);
...
int lua_fairygui_GSlider_setValue(lua_State* tolua_S)
{
    int argc = 0;
...
int lua_fairygui_GSlider_setMax(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GSlider* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GSlider_getValue(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GSlider* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GSlider_getValue'", nullptr);
            return 0;
        }
        double ret = cobj->getValue();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_GSlider_getTitleType(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GSlider* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GSlider_getTitleType'", nullptr);
            return 0;
        }
        int ret = (int)cobj->getTitleType();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_GSlider_getMax(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GSlider* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GSlider_getMax'", nullptr);
            return 0;
        }
        double ret = cobj->getMax();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
...
int lua_fairygui_GSlider_setTitleType(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GSlider* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GSlider_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GSlider_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_GSlider_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GSlider* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GSlider_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GSlider_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GSlider_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GSlider)");
    return 0;
}

int lua_register_fairygui_GSlider(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GSlider");
        tolua_function(tolua_S,"new",lua_fairygui_GSlider_constructor);
...
int lua_fairygui_Window_getCloseButton(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_getCloseButton'", nullptr);
            return 0;
        }
...
int lua_fairygui_Window_getContentPane(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_getContentPane'", nullptr);
            return 0;
        }
...
int lua_fairygui_Window_show(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_show'", nullptr);
            return 0;
        }
        cobj->show();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_Window_isTop(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_isTop'", nullptr);
            return 0;
        }
        bool ret = cobj->isTop();
        tolua_pushboolean(tolua_S,(bool)ret);
...
int lua_fairygui_Window_hideImmediately(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_hideImmediately'", nullptr);
            return 0;
        }
...
int lua_fairygui_Window_toggleStatus(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_toggleStatus'", nullptr);
            return 0;
        }
        cobj->toggleStatus();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_Window_hide(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_hide'", nullptr);
            return 0;
        }
        cobj->hide();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_Window_getFrame(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_getFrame'", nullptr);
            return 0;
        }
...
int lua_fairygui_Window_isShowing(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_isShowing'", nullptr);
            return 0;
        }
...
int lua_fairygui_Window_closeModalWait(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Window_initWindow(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_initWindow'", nullptr);
            return 0;
        }
        cobj->initWindow();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_Window_setContentArea(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Window_setDragArea(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Window_setContentPane(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Window_isModal(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_isModal'", nullptr);
            return 0;
        }
...
int lua_fairygui_Window_isBringToFrontOnClick(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_isBringToFrontOnClick'", nullptr);
            return 0;
        }
...
int lua_fairygui_Window_getContentArea(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_getContentArea'", nullptr);
            return 0;
        }
...
int lua_fairygui_Window_setBringToFrontOnClick(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Window_setModal(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Window_getModalWaitingPane(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_getModalWaitingPane'", nullptr);
            return 0;
        }
...
int lua_fairygui_Window_getDragArea(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_getDragArea'", nullptr);
            return 0;
        }
...
int lua_fairygui_Window_bringToFront(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_bringToFront'", nullptr);
            return 0;
        }
        cobj->bringToFront();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_Window_showModalWait(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Window_setCloseButton(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Window_addUISource(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_Window_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_Window_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::Window* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_Window_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_Window_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_Window_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (Window)");
    return 0;
}

int lua_register_fairygui_Window(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Window");
        tolua_function(tolua_S,"new",lua_fairygui_Window_constructor);
...
int lua_fairygui_GRoot_closeAllWindows(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_closeAllWindows'", nullptr);
            return 0;
        }
...
int lua_fairygui_GRoot_hideTooltips(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_hideTooltips'", nullptr);
            return 0;
        }
        cobj->hideTooltips();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_GRoot_hasAnyPopup(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_hasAnyPopup'", nullptr);
            return 0;
        }
...
int lua_fairygui_GRoot_getTopWindow(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_getTopWindow'", nullptr);
            return 0;
        }
...
int lua_fairygui_GRoot_hidePopup(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GRoot_closeAllExceptModals(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_closeAllExceptModals'", nullptr);
            return 0;
        }
...
int lua_fairygui_GRoot_showPopup(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GRoot_showTooltipsWin(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GRoot_closeModalWait(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_closeModalWait'", nullptr);
            return 0;
        }
        cobj->closeModalWait();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_GRoot_getInputProcessor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_getInputProcessor'", nullptr);
            return 0;
        }
...
int lua_fairygui_GRoot_getSoundVolumeScale(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_getSoundVolumeScale'", nullptr);
            return 0;
        }
...
int lua_fairygui_GRoot_togglePopup(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GRoot_isSoundEnabled(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_isSoundEnabled'", nullptr);
            return 0;
        }
...
int lua_fairygui_GRoot_setSoundVolumeScale(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GRoot_getTouchTarget(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_getTouchTarget'", nullptr);
            return 0;
        }
...
int lua_fairygui_GRoot_hideWindowImmediately(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GRoot_getModalLayer(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_getModalLayer'", nullptr);
            return 0;
        }
...
int lua_fairygui_GRoot_playSound(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GRoot_getModalWaitingPane(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_getModalWaitingPane'", nullptr);
            return 0;
        }
        fairygui::GObject* ret = cobj->getModalWaitingPane();
        object_to_luaval<fairygui::GObject>(tolua_S, "fgui.GObject",(fairygui::GObject*)ret);
...
int lua_fairygui_GRoot_setSoundEnabled(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GRoot_bringToFront(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GRoot_hasModalWindow(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_hasModalWindow'", nullptr);
            return 0;
        }
...
int lua_fairygui_GRoot_showModalWait(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_showModalWait'", nullptr);
            return 0;
        }
        cobj->showModalWait();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_GRoot_isModalWaiting(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_isModalWaiting'", nullptr);
            return 0;
        }
...
int lua_fairygui_GRoot_getTouchPosition(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GRoot_getPoupPosition(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GRoot_showWindow(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GRoot_showTooltips(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GRoot_hideWindow(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GRoot_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
int lua_fairygui_GRoot_getInstance(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_getInstance'", nullptr);
            return 0;
        }
...
int lua_fairygui_GRoot_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GRoot* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GRoot_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GRoot_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GRoot_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GRoot)");
    return 0;
}

int lua_register_fairygui_GRoot(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GRoot");
        tolua_function(tolua_S,"new",lua_fairygui_GRoot_constructor);
...
int lua_fairygui_PopupMenu_setItemGrayed(lua_State* tolua_S)
{
    int argc = 0;
...
int lua_fairygui_PopupMenu_getItemName(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::PopupMenu* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_PopupMenu_clearItems(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::PopupMenu* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_PopupMenu_clearItems'", nullptr);
            return 0;
        }
        cobj->clearItems();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_PopupMenu_getList(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::PopupMenu* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_PopupMenu_getList'", nullptr);
            return 0;
        }
...
int lua_fairygui_PopupMenu_removeItem(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::PopupMenu* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_PopupMenu_addItem(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::PopupMenu* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_PopupMenu_addSeperator(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::PopupMenu* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_PopupMenu_addSeperator'", nullptr);
            return 0;
        }
        cobj->addSeperator();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_PopupMenu_addItemAt(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::PopupMenu* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_PopupMenu_setItemText(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::PopupMenu* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_PopupMenu_setItemChecked(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::PopupMenu* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_PopupMenu_show(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::PopupMenu* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_PopupMenu_getContentPane(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::PopupMenu* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_PopupMenu_getContentPane'", nullptr);
            return 0;
        }
        fairygui::GComponent* ret = cobj->getContentPane();
        object_to_luaval<fairygui::GComponent>(tolua_S, "fgui.GComponent",(fairygui::GComponent*)ret);
...
int lua_fairygui_PopupMenu_getItemCount(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::PopupMenu* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_PopupMenu_getItemCount'", nullptr);
            return 0;
        }
...
int lua_fairygui_PopupMenu_setItemCheckable(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::PopupMenu* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_PopupMenu_isItemChecked(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::PopupMenu* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_PopupMenu_setItemVisible(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::PopupMenu* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_PopupMenu_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
#if COCOS2D_DEBUG >= 1
...
int lua_fairygui_PopupMenu_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::PopupMenu* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_PopupMenu_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_PopupMenu_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_PopupMenu_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (PopupMenu)");
    return 0;
}

int lua_register_fairygui_PopupMenu(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"PopupMenu");
        tolua_function(tolua_S,"new",lua_fairygui_PopupMenu_constructor);
...
int lua_fairygui_UIObjectFactory_setLoaderExtension(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 1)
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_UIObjectFactory_setLoaderExtension'", nullptr);
            return 0;
        }
...
int lua_fairygui_UIObjectFactory_newObject(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
#if COCOS2D_DEBUG >= 1
...
int lua_fairygui_UIObjectFactory_setPackageItemExtension(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 2)
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_UIObjectFactory_setPackageItemExtension'", nullptr);
            return 0;
        }
...
static int lua_fairygui_UIObjectFactory_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (UIObjectFactory)");
    return 0;
}

int lua_register_fairygui_UIObjectFactory(lua_State* tolua_S)
{
...
int lua_fairygui_GTweener_getRepeat(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTweener_getRepeat'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTweener_getDuration(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTweener_getDuration'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTweener_getTarget(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTweener_getTarget'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTweener_allCompleted(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTweener_allCompleted'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTweener_getUserData(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTweener_getUserData'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTweener_isCompleted(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTweener_isCompleted'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTweener_getNormalizedTime(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTweener_getNormalizedTime'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTweener_setTargetAny(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTweener* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_GTweener_setTargetAny'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTweener_setTargetAny'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GTweener_setTargetAny'.",&tolua_err);
#endif
...
int lua_fairygui_GTweener_getDelay(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTweener_getDelay'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTweener_onComplete1(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTweener* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GTweener_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTweener_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GTweener_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GTweener_finalize(lua_State* tolua_S)
{
...
int lua_register_fairygui_GTweener(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GTweener");
        ...
        tolua_function(tolua_S,"setTargetAny",lua_fairygui_GTweener_setTargetAny);
...
int lua_fairygui_GTween_clean(lua_State* tolua_S)
{
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTween_clean'", nullptr);
            return 0;
        }
...
static int lua_fairygui_GTween_finalize(lua_State* tolua_S)
{
...
int lua_fairygui_DefaultListFooter_isReadyToRefresh(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::DefaultListFooter* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"fgui.DefaultListFooter",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (fairygui::DefaultListFooter*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_DefaultListFooter_isReadyToRefresh'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_DefaultListFooter_isReadyToRefresh'", nullptr);
            return 0;
        }
        bool ret = cobj->isReadyToRefresh();
        tolua_pushboolean(tolua_S,(bool)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fgui.DefaultListFooter:isReadyToRefresh",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_DefaultListFooter_isReadyToRefresh'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_DefaultListFooter_setRefreshStatus(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::DefaultListFooter* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_DefaultListFooter_setRefreshStatus'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "fgui.DefaultListFooter:setRefreshStatus");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_DefaultListFooter_setRefreshStatus'", nullptr);
            return 0;
        }
        cobj->setRefreshStatus(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fgui.DefaultListFooter:setRefreshStatus",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_DefaultListFooter_setRefreshStatus'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_DefaultListFooter_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S,1,"fgui.DefaultListFooter",0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_DefaultListFooter_create'", nullptr);
            return 0;
        }
        fairygui::DefaultListFooter* ret = fairygui::DefaultListFooter::create();
        object_to_luaval<fairygui::DefaultListFooter>(tolua_S, "fgui.DefaultListFooter",(fairygui::DefaultListFooter*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "fgui.DefaultListFooter:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_DefaultListFooter_create'.",&tolua_err);
#endif
    return 0;
}
static int lua_fairygui_DefaultListFooter_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (DefaultListFooter)");
    return 0;
}

int lua_register_fairygui_DefaultListFooter(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"fgui.DefaultListFooter");
    tolua_cclass(tolua_S,"DefaultListFooter","fgui.DefaultListFooter","fgui.GComponent",nullptr);

    tolua_beginmodule(tolua_S,"DefaultListFooter");
        tolua_function(tolua_S,"isReadyToRefresh",lua_fairygui_DefaultListFooter_isReadyToRefresh);
        tolua_function(tolua_S,"setRefreshStatus",lua_fairygui_DefaultListFooter_setRefreshStatus);
        tolua_function(tolua_S,"create", lua_fairygui_DefaultListFooter_create);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(fairygui::DefaultListFooter).name();
    g_luaType[typeName] = "fgui.DefaultListFooter";
    g_typeCast["DefaultListFooter"] = "fgui.DefaultListFooter";
    return 1;
}

int lua_fairygui_DefaultListHeader_isReadyToRefresh(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::DefaultListHeader* cobj = nullptr;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"fgui.DefaultListHeader",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (fairygui::DefaultListHeader*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_DefaultListHeader_isReadyToRefresh'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_DefaultListHeader_isReadyToRefresh'", nullptr);
            return 0;
        }
        bool ret = cobj->isReadyToRefresh();
        tolua_pushboolean(tolua_S,(bool)ret);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fgui.DefaultListHeader:isReadyToRefresh",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_DefaultListHeader_isReadyToRefresh'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_DefaultListHeader_setRefreshStatus(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::DefaultListHeader* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_DefaultListHeader_setRefreshStatus'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "fgui.DefaultListHeader:setRefreshStatus");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_DefaultListHeader_setRefreshStatus'", nullptr);
            return 0;
        }
        cobj->setRefreshStatus(arg0);
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "fgui.DefaultListHeader:setRefreshStatus",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_DefaultListHeader_setRefreshStatus'.",&tolua_err);
#endif

    return 0;
}
int lua_fairygui_DefaultListHeader_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertable(tolua_S,1,"fgui.DefaultListHeader",0,&tolua_err)) goto tolua_lerror;
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_DefaultListHeader_create'", nullptr);
            return 0;
        }
        fairygui::DefaultListHeader* ret = fairygui::DefaultListHeader::create();
        object_to_luaval<fairygui::DefaultListHeader>(tolua_S, "fgui.DefaultListHeader",(fairygui::DefaultListHeader*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "fgui.DefaultListHeader:create",argc, 0);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_DefaultListHeader_create'.",&tolua_err);
#endif
    return 0;
}
static int lua_fairygui_DefaultListHeader_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (DefaultListHeader)");
    return 0;
}

int lua_register_fairygui_DefaultListHeader(lua_State* tolua_S)
{
    tolua_usertype(tolua_S,"fgui.DefaultListHeader");
    tolua_cclass(tolua_S,"DefaultListHeader","fgui.DefaultListHeader","fgui.GComponent",nullptr);

    tolua_beginmodule(tolua_S,"DefaultListHeader");
        tolua_function(tolua_S,"isReadyToRefresh",lua_fairygui_DefaultListHeader_isReadyToRefresh);
        tolua_function(tolua_S,"setRefreshStatus",lua_fairygui_DefaultListHeader_setRefreshStatus);
        tolua_function(tolua_S,"create", lua_fairygui_DefaultListHeader_create);
    tolua_endmodule(tolua_S);
    std::string typeName = typeid(fairygui::DefaultListHeader).name();
    g_luaType[typeName] = "fgui.DefaultListHeader";
    g_typeCast["DefaultListHeader"] = "fgui.DefaultListHeader";
    return 1;
}
TOLUA_API int register_all_fairygui(lua_State* tolua_S)
{
    tolua_open(tolua_S);
    ...
    lua_register_fairygui_Relations(tolua_S);
    ...
    lua_register_fairygui_DefaultListHeader(tolua_S);
    lua_register_fairygui_DefaultListFooter(tolua_S);
